...
const contractABI = require("../artifacts/contracts/Cryptoframe.sol/Cryptoframe.json").abi;

program
    .name("cryptoframe-cli")
    .description("CLI tool for Cryptoframe smart contract")
    .version("1.0.0");
