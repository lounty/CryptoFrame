 ...
 * This file demonstrates how to integrate Cryptoframe with a web frontend
 */

// For React/Vue/Angular applications
export class CryptoframeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CryptoframeClient(provider, contractAddress);
